...
let fullscreen_help_generated = """
    USAGE: fullscreen [-h|--help]     [--window-id <window-id>] [--no-outer-gaps] [--frame <x,y,w,h>]
       OR: fullscreen [-h|--help] on  [--window-id <window-id>] [--no-outer-gaps] [--frame <x,y,w,h>] [--fail-if-noop]
